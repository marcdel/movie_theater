...
var _user$project$MovieTheater$Seat = F2(
	function (a, b) {
...
var _user$project$MovieTheater$seatItem = function (seat) {
		...
		_elm_lang$html$Html$li,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$MovieTheater$Toggle(seat)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$MovieTheater$view = function (model) {
	return A2(
...
var _user$project$MovieTheater$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$MovieTheater$init, update: _user$project$MovieTheater$update, view: _user$project$MovieTheater$view})();

var Elm = {};
Elm['MovieTheater'] = Elm['MovieTheater'] || {};
if (typeof _user$project$MovieTheater$main !== 'undefined') {
    _user$project$MovieTheater$main(Elm['MovieTheater'], 'MovieTheater', undefined);
}
